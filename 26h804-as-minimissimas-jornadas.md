---
layout: single
title: "As minimíssimas jornadas"
date: 2026-08-07 05:00:00 -0300
permalink: /26h804-as-minimissimas-jornadas/
description: numa rampa do metrô
header:
  og_image: "https://mrclmlt.com.br/i/26h804-as-minimissimas-jornadas.jpg"
---

Embora o assunto do BEDA seja "[Conte como foi um dia comum da sua rotina](https://entreblogs.com.br/beda/2026#:~:text=As%20Pequenas%20Jornadas){:target="_blank"}", eu vou reduzir arbitrariamente o tempo (e o espaço) para "um minuto comum da sua rotina", e talvez não dure nem um minuto a descida da rampa da estação [Artur Alvim](https://pt.wikipedia.org/wiki/Esta%C3%A7%C3%A3o_Artur_Alvim){:target="_blank"}. Mais especificamente, a rampa que passa por cima dos trilhos da CPTM e vai para o lado do terminal de ônibus (tem outra, menorzinha, que dá direto na rua do outro lado).  
...
![Foto da hoje desativada estação Engº. Artur Alvim da CPTM, mostrando os trilhos, a plataforma e a passarela que sai da estação do metrô com o mesmo nome (sem a parte do "engenheiro") e vai dar no terminal de ônibus.](https://mrclmlt.com.br/i/26h804-as-minimissimas-jornadas.jpg)<small>A rampa vista pelo lado de fora.</small>

Às vezes dá a sorte de pegar um intervalo entre uma leva e outra, e para ser justo, as pessoas não invadem o lado menor sem necessidade. Se tem espaço para disparar enlouquecidamente na via mais larga, as pessoas vão por ela. 
Às vezes dá o azar de alguém vir e dobrar a aposta. Já me aconteceu de ver os reflexos de luzes brilhando atrás de mim, e quando eu fui ver, era um sujeito descendo de bicicleta, abrindo caminho à força, tanto entre quem descia a rampa como ele, quanto entre quem subia a rampa, porque era isso ou ser atropelado.  
Tem placas por ali dizendo que não é para usar as rampas de bicicleta, e longe de mim virar um defensor ferrenho das regras<sup>1</sup>, mas tem horas, como essas, em que elas deveriam valer tanto quanto artigos da constituição.  
...
---
<small>A imagem é do site [Estações Ferroviárias do Brasil](https://www.estacoesferroviarias.com.br/a/artalvim.htm){:target="_blank"}</small>

<sup>1</sup> Parafraseando a Bíblia, as regras foram feitas para o ser humano, e não o ser humano para as regras.

<sup>2</sup> Nunca aconteceu nada demais no fim das contas, só o que se vê é o perigo rondando a rampa, sem nunca atacar (pelo menos que eu saiba(.
